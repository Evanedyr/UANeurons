...
#define tau _p[7]
#define mu _p[8]
#define new_seed _p[9]
#define i _p[10]
#define ival _p[11]
#define noise _p[12]
#define sinuspart _p[13]
#define ou _p[14]
#define lastou _p[15]
#define on _p[16]
#define _g _p[17]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 IClampNoiseSin /home/christophe/Documents/Git/UANeurons/Code/Neuron/BallStickModel/x86_64/IClampNoiseAndSine.mod\n");
...
#endif
{
 ...
 if ( on ) {
     noise = normrand ( 0.0 , 1.0 ) * 1.0 ;
     sinuspart = amp * sin ( freq * 2.0 * 3.14 * t ) ;
     ou = lastou * exp ( - dt / tau ) + mu * ( 1.0 - exp ( - dt / tau ) ) + std * sqrt ( 1.0 - exp ( - 2.0 * dt / tau ) ) * noise ;
...
{
 {
   ...
   seed ( _threadargscomma_ new_seed ) ;
   }
