...
def define_biophysics(*arg):
    ...
    2st argument: cell
    3rd argument: Sodium conductance            (in pS/um^2)
    4th argument: Potassium conductance         (in pS/um^2)
    5th argument: Leak conductance              (in pS/um^2)
    ...
    if arg[0] == 2:
        ...
        arg[1].tha_na = arg[10]
        arg[1].qa_na = arg[11]
        arg[1].thinf_na = arg[12]
        arg[1].qinf_na = arg[13]
        arg[1].tha_kv = arg[14]
        arg[1].qa_kv = arg[15]
